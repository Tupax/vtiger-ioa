...
$s_bloque_principal = Vtiger_Block::getInstance('LBL_SUCURSALES_INFORMATION', $moduleInstance);
if (!$s_bloque_principal) {
    $s_bloque_principal = new Vtiger_Block();
    $s_bloque_principal->label = 'LBL_SUCURSALES_INFORMATION';
    $moduleInstance->addBlock($s_bloque_principal);
}

$s_bloque_dentrega = Vtiger_Block::getInstance('LBL_SUCURSALES_DIRENTREGA_INFORMATION', $moduleInstance);
if (!$s_bloque_dentrega) {
    $s_bloque_dentrega = new Vtiger_Block();
    $s_bloque_dentrega->label = 'LBL_SUCURSALES_DIRENTREGA_INFORMATION';
    $moduleInstance->addBlock($s_bloque_dentrega);
}

$s_bloque_dcobranza = Vtiger_Block::getInstance('LBL_SUCURSALES_DIRCOBRANZA_INFORMATION', $moduleInstance);
if (!$s_bloque_dcobranza) {
    $s_bloque_dcobranza = new Vtiger_Block();
    $s_bloque_dcobranza->label = 'LBL_SUCURSALES_DIRCOBRANZA_INFORMATION';
